...
export default function AddRestaurant() {
  ...
  if (errors) {
    for (let error of errors) {
      ...
      if (error.msg.includes("Cost for one cannot")) costForOneError = error.msg;
            ...
            <Grid container>
              <Grid item sm>
                ...
                <form noValidate onSubmit={handleSubmit}>
                  ...
                  {serverError && (
                    <Typography variant="inherit" className={classes.customError}>
                  ...
                  >
                    Partner with Toptal and scale your business
                  </small>
                </form>
              </Grid>
            </Grid>
        ...
        <Grid item xs={3} style={{ marginLeft: "40px" }}>
          ...
          >
            ...
            >
              ...
              2. Access Restaurant Dashboard and go live.
              <br />
              <br />
              <br />
            </Typography>
